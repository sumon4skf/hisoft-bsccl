        ...
        if (!$this->Auth->user()) {
            if ($this->request->is('post')) {
                ...
                if($this->userRoleCheck($this->request->data)) {
                    ...
                    return $this->redirect('/');
//                    $error_message = __('You dont have permission to login');
//                    $this->Flash->adminError($error_message, ['key' => 'admin_error']);
//                    return $this->redirect(['controller' => 'users', 'action' => 'login']);
    ...
    private function userRoleCheck($user_data) {     // Checking user is admin or not
    ...
    private function adminApprovalCheck($user_data) {     // Checking user by admin approval
