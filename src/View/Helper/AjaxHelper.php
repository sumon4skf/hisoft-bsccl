 ...
 * @var array
 */
	var $helpers = ['Html', 'Form', 'Javascript','Url'];
 ...
 */
	function remoteFunction($options) {
        ...
        $options['url'] = $this->Url->assetUrl(isset($options['url']) ? $options['url'] : "");
 ...
 //TODO Moze jednak to kiedys naprawics
	...
	public function url($url = null, $full = false) {
		if(isset($this->params['locale'])) {
			if (!isset($url['locale']) && is_array($this->params) && isset($this->params['locale'])) {
